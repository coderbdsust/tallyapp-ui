...
import { AccountBalanceViewerComponent } from '../../components/account-balance-viewer/account-balance-viewer.component';

@Component({
  selector: 'app-report',
  imports: [TransactionViewComponent, AccountBalanceViewerComponent],
  templateUrl: './report.component.html',
  styleUrl: './report.component.scss'
})
export class ReportComponent extends PaginatedComponent<Transaction> implements OnInit, OnDestroy{
